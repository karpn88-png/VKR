    ...
    <div className="page">
      ...
      <main className="hero">
        <section className="hero-left">
          ...
          <Link to="/teacher-work" className="continue-link">
      ...
      <section className="cards">
        <Link to="/teacher-cabinet" className="card-link">
          <Card
            icon={avatar}
        ...
        <Link to="/teacher-work" className="card-link">
          <Card
            icon={people}
            title="Мои студенты"
        ...
        <Link to="/mytopic" className="card-link">
          <Card
            icon={idea}
            title="Мои темы для ВКР"
            text="Предложить тематику для написания ВКР"
          />
        </Link>
      </section>
